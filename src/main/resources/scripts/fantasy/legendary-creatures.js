  ...
  for (i = 0; i < count; i++) {
    ...
    if (i < count * 0.5) {
      ...
      if (i < count * 0.3) {
        ...
        if (
          nm1[rnd].charAt(nmRep) === "a" ||
          nm1[rnd].charAt(nmRep) === "e" ||
          nm1[rnd].charAt(nmRep) === "i" ||
          nm1[rnd].charAt(nmRep) === "o" ||
          nm1[rnd].charAt(nmRep) === "u" ||
          nm1[rnd].charAt(nmRep) === "y"
        ) {
      ...
      if (i < count * 0.8) {
        ...
        if (
          nm2[rnd].charAt(nmRep) === "a" ||
          nm2[rnd].charAt(nmRep) === "e" ||
          nm2[rnd].charAt(nmRep) === "i" ||
          nm2[rnd].charAt(nmRep) === "o" ||
          nm2[rnd].charAt(nmRep) === "u" ||
          nm2[rnd].charAt(nmRep) === "y"
        ) {
          nmRepl = nm3[(Math.random() * nm3.length) | 0];
        } else {
          nmRepl = nm4[(Math.random() * nm4.length) | 0];
